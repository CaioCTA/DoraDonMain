...
public class PlayFabMatchmaking : MonoBehaviour
{
    ...
    // Método para obter latência (exemplo simplificado)

    // callback sucesso cria��o ticket
    ...
    // callback de erro em requisi��es do playfabs
    ...
    {
        // requisi��o para monitorar a fila/tickets
    ...
    private void OnGetMatched(GetMatchResult result)
    {
        ...
        CreateGame criaConectar = FindObjectOfType<CreateGame>();
        ...
        {
            isHost = true;
            Debug.Log($"[Matchmaker] Voc� � o host da sala!");
        }
        else
        {
            isHost = false;
            Debug.Log($"[Matchmaker] Voc� � apenas mais um..");
        }
